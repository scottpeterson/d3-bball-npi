...
def simulate_game(
    ...
    """Core game simulation logic with tie handling"""
    while True:  # Keep simulating until we get a non-tie result
        ...
        # Skip to next iteration if it's a tie
        if abs(actual_diff) < 0.01:  # Use small epsilon to handle floating point comparison
            continue
        ...
        # Double check for ties after rounding
